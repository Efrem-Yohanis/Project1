...
urlpatterns = [
    ...
    path('delete_region/<int:pk>',views.RegionDelete, name='delete-region'),
    path('delete_region/', views.RegionDeleteComplet, name='delete_region_complet'),
    ...
    path('Finance_Admin/aprove_order_history',views.aprove_order_history_view, name='aprove-order-history'),
     path('Finance_Admin/unaprove_order_history',
         views.unapproves_Order, name='unaprove-order-history'),
     path('Finance_Admin/reject_order/<int:pk>',views.reject_order, name='reject_order'),
     path('Finance_Admin/Reject_order_list',views.Reject_order_list, name='Reject_order_list'),
    ...
    path('new_examlpe/',views.new_examlpe,name='new_examlpe'),
]
