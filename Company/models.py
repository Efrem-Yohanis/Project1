...
class Company_Store(models.Model):
    ...
    OnMap = models.CharField(max_length=2000,null=True,blank=True)
    def __str__(self) -> str:
...
class ProductNew(models.Model):
    ...
    Price_in_botle_Agent_buy=models.FloatField(null=True,blank=True)
    Price_in_creates_Agent_buy=models.FloatField(null=True,blank=True)
    Price_in_botle_Agent_sell=models.FloatField(null=True,blank=True)
    Price_in_creates_Agent_sell=models.FloatField(null=True,blank=True)
    Price_in_botle_Custom_recom=models.FloatField(null=True,blank=True)
...
class yenePay(models.Model):
    ...
    MerchantId = models.CharField(max_length=2000, blank=True, null=True)