...
from Company.models import ProductNew,Advertisment
        ...
        #   marchentId
            ...
            if request.method == 'POST':
                for product in all_product:
                    ...
                    tp = product.Price_in_creates_Agent_sell * \
                ...
                obj = {
                    "process": "Cart",
                    "successUrl": "http://192.168.8.129:8002/Customer/success/",
                    "ipnUrl": "http://192.168.8.129:8002/Customer/ipn",
                    "cancelUrl": "http://192.168.8.129:8002/Customer/cancel",
                    "merchantId": MI,
